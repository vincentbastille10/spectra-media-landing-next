    ...
    <>
        ...
        <div className="wrap">
          ...
          <div className="products">
            <div className="card">
              ...
              <p style={{color:'#444'}}>Agent conversationnel qui qualifie, route et prend des RDV (Calendly). Site ou WhatsApp. Branché Sheets/CRM.</p>
            ...
            <div className="card">
              ...
              <p style={{color:'#444'}}>Détecte tendances par grappes → idées testables (MVP, hooks, contenus) → moves concrets.</p>
              <ul style={{marginTop:8,color:'#555',fontSize:14,lineHeight:1.7}}>
            ...
            <div className="card">
              ...
              <p style={{color:'#444'}}>Récupère Gmail + PDF, extrait TTC/TVA/dates, dédoublonne et remplit Google Sheets.</p>
              <ul style={{marginTop:8,color:'#555',fontSize:14,lineHeight:1.7}}>
      ...
      <section id="contact" className="section">
        <div className="wrap">
          ...
          <p style={{color:'#666',margin:'8px 0 16px'}}>Expliquez l’objectif et on vous propose le setup le plus court vers la valeur.</p>
