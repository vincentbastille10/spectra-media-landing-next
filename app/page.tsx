    ...
    <>
        ...
        <div className="wrap grid md:grid-cols-[1.2fr_.8fr] gap-10 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
              ...
              & outils <span className="text-rainbow">.dmg</span>
            </h1>
            <p className="mt-4 text-lg text-gray-600">
              Des agents qui qualifient, une veille IA prédictive actionnable, et des utilitaires macOS qui trient vos factures. Rapide à déployer. Mesurable. Rentable.
            </p>
      ...
      <section id="produits" className="section">
        <div className="wrap">
          ...
          <p className="text-gray-600 mb-6">Choisissez le point d’impact le plus direct. Nous intégrons à votre stack existante.</p>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="card">
              ...
              <p className="mt-2 text-gray-700">Agent conversationnel qui qualifie, route et prend des RDV (Calendly). Site ou WhatsApp. Branché Sheets/CRM.</p>
            ...
            <div className="card">
              ...
              <p className="mt-2 text-gray-700">Détecte tendances par grappes → idées testables (MVP, hooks, contenus) → moves concrets.</p>
              <ul className="list-disc ml-5 mt-3 text-sm text-gray-600 space-y-1">
                <li>Détection par grappes</li>
                <li>Idées prêtes à tester</li>
                <li>Remontées hebdo + alertes</li>
              </ul>
              <Link className="btn btn-primary mt-4" href="/blog/comment-nous-produisons-innovationpulse">InnovationPulse sur Gumroad</Link>
            </div>

            <div className="card">
              <span className="badge mb-3">UTILITAIRE MACOS</span>
              <h3 className="text-2xl font-semibold">Trieur de factures — .dmg local-first</h3>
              <p className="mt-2 text-gray-700">Récupère Gmail + PDF, extrait TTC/TVA/dates, dédoublonne et remplit Google Sheets.</p>
              <ul className="list-disc ml-5 mt-3 text-sm text-gray-600 space-y-1">
